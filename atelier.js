...
(() => {
 ...
 const brand=document.createElement('div');brand.className='mobile-brand';brand.innerHTML='<img src="unipop-logo.png" alt="UniPop"><span>STOCK / 03</span>';$('.main').prepend(brand);
